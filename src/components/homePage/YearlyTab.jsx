    ...
    return (
        <div>
            <div className='flex flex-wrap justify-center gap-[20px]'>
                ...
                {/* Basic Plan */}
                <div className='w-[358px] laptop:w-[413px]  laptop:p-10 p-[30px] rounded-[10px] border-[1px] border-[#EEF8D3] bg-[#F6FBE9] flex flex-col gap-6'>
                    <div>
                    ...
                    <p><span className='text-[#2C5446] font-bold text-[40px] laptop:text-[42px]'>$39</span> <span className='text-[#333333] font-medium'>/month</span></p>
                ...
                <div className='w-[358px] laptop:w-[413px]  laptop:p-10 p-[30px] rounded-[10px] border-[1px] border-[#EEF8D3] bg-[#F6FBE9] flex flex-col gap-6 '>
                    ...
                    <p><span className='text-[#2C5446] font-bold text-[40px] laptop:text-[42px]'>$59</span> <span className='text-[#333333] font-medium'>/month</span></p>
                    <p className='py-[14px] px-6 bg-[#CBEA7B] text-center text-[14px] laptop:text-[16px] font-semibold rounded-[6px] text-[#262626]'>Choose Plan</p>
                </div>
