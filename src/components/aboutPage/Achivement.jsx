...
const Achivement = () => {
    return (
        <div className="mt-[50px] medium:mt-20 laptop:mt-[100px] px-4 tablet:px-10 medium:px-[60px] laptop:px-20">
            ...
            <div className='mt-[50px] h-[218px] laptop:mt-[100px] p-[60px]  bg-[#F6FBE9] border-[1px] border-[#E5F5BD] rounded-[10px] relative overflow-hidden'>
                <div className='flex gap-[150px]'>
                    <div>
                        <p className='font-semibold text-[#262626] text-[26px] mb-[10px]'>We Are Proud of Our Achievements</p>
                        <p className='font-medium text-[#333333]'>But our ultimate satisfaction comes from seeing our clients achieve their goals and live healthier, happier lives. Join Nutritionist <br /> today and embark on your own transformative journey towards optimal health and well-being.</p>
                    </div>
                    <div className='flex items-center'>
                        <p className='bg-[#CBEA7B] py-[14px] px-5 rounded-[6px]'>Book A Demo</p>
                    </div>
                </div>
                <Image
